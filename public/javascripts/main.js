																																			...
																																			return function (loggedInPage) {
																																				return function (device) {
																																					return function (window) {
																																						return {completedFromTime: completedFromTime, completedFromTimeFrame: completedFromTimeFrame, completedList: completedList, completedToTime: completedToTime, completedToTimeFrame: completedToTimeFrame, currentProject: currentProject, currentTime: currentTime, device: device, editingEndTime: editingEndTime, editingEndTimeFrame: editingEndTimeFrame, editingId: editingId, editingNote: editingNote, editingProject: editingProject, editingStartTime: editingStartTime, editingStartTimeFrame: editingStartTimeFrame, loggedInPage: loggedInPage, loginStatus: loginStatus, newProject: newProject, note: note, password: password, projectList: projectList, projectShown: projectShown, showByStartTime: showByStartTime, showEditingCompletedProjectDropDown: showEditingCompletedProjectDropDown, showEditingEndTimeDropDown: showEditingEndTimeDropDown, showEditingStartTimeDropDown: showEditingStartTimeDropDown, showFilterByProject: showFilterByProject, showFilterByProjectDropDown: showFilterByProjectDropDown, showProjectDropDown: showProjectDropDown, showTimeFrameFromDropDown: showTimeFrameFromDropDown, showTimeFrameToDropDown: showTimeFrameToDropDown, startTime: startTime, timeFrameList: timeFrameList, timeZone: timeZone, timing: timing, userId: userId, userName: userName, window: window};
																																					};
																																				};
																																			};
																																		};
...
var $author$project$Model$Model$Second = {$: 'Second'};
var $author$project$Model$Model$Year = {$: 'Year'};
			...
			F2(
				function (w, h) {
					...
					return $author$project$Model$Model$InitViewport(
						{
							scene: {height: fh, width: fw},
							viewport: {height: fh, width: fw, x: fw, y: fh}
						});
				}))
		]);
	...
	return (!$elm$core$List$length(
		A2(
			...
			function (existingProjectName) {
				return _Utils_eq(existingProjectName, model.newProject);
			},
			model.projectList))) ? (model.timing ? _Utils_update(
		model,
		{
			newProject: '',
...
var $author$project$Update$Update$changeCompletedTime = F3(
	function (model, startOrEnd, incOrDec) {
		...
		var years = days * 365;
		if (startOrEnd.$ === 'Start') {
			var _v1 = model.completedFromTimeFrame;
			switch (_v1.$) {
				case 'Second':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							model,
							{
								completedFromTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedFromTime) + secs)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Minute':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								completedFromTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedFromTime) + mins)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Hour':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								completedFromTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedFromTime) + hours)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Day':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								completedFromTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedFromTime) + days)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Month':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								completedFromTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedFromTime) + months)
							});
					} else {
						return _Utils_update(
							model,
				...
				default:
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								completedFromTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedFromTime) + years)
							});
					} else {
						return _Utils_update(
							model,
			...
			var _v8 = model.completedToTimeFrame;
			switch (_v8.$) {
				case 'Second':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							model,
							{
								completedToTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedToTime) + secs)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Minute':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								completedToTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedToTime) + mins)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Hour':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								completedToTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedToTime) + hours)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Day':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								completedToTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedToTime) + days)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Month':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								completedToTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedToTime) + months)
							});
					} else {
						return _Utils_update(
							model,
				...
				default:
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								completedToTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedToTime) + years)
							});
					} else {
						return _Utils_update(
							model,
...
var $author$project$Update$Update$changeEditTime = F3(
	function (model, startOrEnd, incOrDec) {
		if (startOrEnd.$ === 'Start') {
			var _v1 = model.editingStartTimeFrame;
			switch (_v1.$) {
				case 'Second':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							model,
							{
								editingStartTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingStartTime) + $author$project$Model$Model$secs)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Minute':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								editingStartTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingStartTime) + $author$project$Model$Model$mins)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Hour':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								editingStartTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingStartTime) + $author$project$Model$Model$hours)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Day':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								editingStartTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingStartTime) + $author$project$Model$Model$days)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Month':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								editingStartTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingStartTime) + $author$project$Model$Model$months)
							});
					} else {
						return _Utils_update(
							model,
				...
				default:
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								editingStartTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingStartTime) + $author$project$Model$Model$years)
							});
					} else {
						return _Utils_update(
							model,
			...
			var _v8 = model.editingEndTimeFrame;
			switch (_v8.$) {
				case 'Second':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							model,
							{
								editingEndTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingEndTime) + $author$project$Model$Model$secs)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Minute':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								editingEndTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingEndTime) + $author$project$Model$Model$mins)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Hour':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								editingEndTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingEndTime) + $author$project$Model$Model$hours)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Day':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								editingEndTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingEndTime) + $author$project$Model$Model$days)
							});
					} else {
						return _Utils_update(
							model,
				...
				case 'Month':
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								editingEndTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingEndTime) + $author$project$Model$Model$months)
							});
					} else {
						return _Utils_update(
							model,
				...
				default:
					if (incOrDec.$ === 'Increment') {
						return _Utils_update(
							...
							{
								editingEndTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.editingEndTime) + $author$project$Model$Model$years)
							});
					} else {
						return _Utils_update(
							model,
...
var $author$project$Model$Model$Completed = F5(
	function (id, project, startTime, endTime, note) {
		return {endTime: endTime, id: id, note: note, project: project, startTime: startTime};
	});
...
var $author$project$Update$Update$getUserHistory = function (maybeUserId) {
	if (maybeUserId.$ === 'Just') {
		...
		return $elm$http$Http$get(
			{
				expect: A2($elm$http$Http$expectJson, $author$project$Model$Model$GotHistory, $author$project$Update$Update$completedListDecoder),
				url: $author$project$Update$Update$api + ('userhistory/' + $elm$core$String$fromInt(userId))
			});
	} else {
		var x = A2($elm$core$Debug$log, 'getUserHistory', 'no userId');
	...
	function (maybeUserId, completedItems, endpoint) {
		if ($elm$core$List$isEmpty(completedItems)) {
			...
			if (maybeUserId.$ === 'Just') {
									...
									return $elm$json$Json$Encode$object(
										_List_fromArray(
											[
												_Utils_Tuple2(
												'id',
												$elm$json$Json$Encode$string(completedItem.id)),
												_Utils_Tuple2(
												'project',
												$elm$json$Json$Encode$string(completedItem.project)),
												_Utils_Tuple2(
												'startTime',
												$elm$json$Json$Encode$int(
													$elm$time$Time$posixToMillis(completedItem.startTime))),
												_Utils_Tuple2(
												'endTime',
												$elm$json$Json$Encode$int(
													$elm$time$Time$posixToMillis(completedItem.endTime))),
												_Utils_Tuple2(
												'note',
												$elm$json$Json$Encode$string(completedItem.note))
											]));
								},
								completedItems)),
						expect: $elm$http$Http$expectWhatever($author$project$Model$Model$CreatedItemList),
						url: _Utils_ap(
				...
				var x = A2($elm$core$Debug$log, 'createItemList', 'no user id');
				return $elm$core$Platform$Cmd$none;
			}
		}
	});
...
var $author$project$Update$Update$deleteCompleted = F2(
	function (model, itemToDelete) {
		var filteredList = A2(
			$elm$core$List$filter,
			function (completedItem) {
				return !_Utils_eq(completedItem.id, itemToDelete.id);
			},
			model.completedList);
		return _Utils_update(
			model,
			{completedList: filteredList, loggedInPage: $author$project$Model$Model$History});
	});
var $author$project$Model$Model$ItemDeleted = function (a) {
	return {$: 'ItemDeleted', a: a};
};
			...
			return $elm$http$Http$request(
				{
					...
					expect: $elm$http$Http$expectWhatever($author$project$Model$Model$ItemDeleted),
					headers: _List_Nil,
					method: 'DELETE',
					timeout: $elm$core$Maybe$Nothing,
					tracker: $elm$core$Maybe$Nothing,
					url: $author$project$Update$Update$api + ($author$project$Update$Update$deleteItemEndPoint + ($elm$core$String$fromInt(userId) + ('/' + item.id)))
				});
		} else {
			return $elm$core$Platform$Cmd$none;
		}
	});
var $author$project$Model$Model$EditingCompleted = {$: 'EditingCompleted'};
var $author$project$Model$Model$ItemUpdated = function (a) {
	return {$: 'ItemUpdated', a: a};
};
			...
			return $elm$http$Http$request(
				{
					...
					expect: $elm$http$Http$expectWhatever($author$project$Model$Model$ItemUpdated),
					headers: _List_Nil,
					method: 'PUT',
					timeout: $elm$core$Maybe$Nothing,
					tracker: $elm$core$Maybe$Nothing,
...
var $author$project$Update$Update$editCompleted = F2(
	function (model, completed) {
		if (_Utils_eq(model.loggedInPage, $author$project$Model$Model$EditingCompleted)) {
			var validStartEnd = _Utils_cmp(
				$elm$time$Time$posixToMillis(model.editingStartTime),
				$elm$time$Time$posixToMillis(model.editingEndTime)) < 0;
			var startTime = validStartEnd ? model.editingStartTime : completed.startTime;
			var note = (model.editingNote === '') ? completed.note : model.editingNote;
			var endTime = validStartEnd ? model.editingEndTime : completed.endTime;
			var editedCompleted = A5($author$project$Model$Model$Completed, completed.id, model.editingProject, startTime, endTime, note);
			var editedList = A2(
				$elm$core$List$map,
				function (comp) {
					return _Utils_eq(comp.id, completed.id) ? editedCompleted : comp;
				},
				model.completedList);
			var saveEditedItemModel = _Utils_update(
				model,
				{
					...
					editingEndTime: $elm$time$Time$millisToPosix(0),
					editingNote: '',
					editingProject: model.currentProject,
					editingStartTime: $elm$time$Time$millisToPosix(0),
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{editingEndTime: completed.endTime, editingId: completed.id, editingNote: completed.note, editingProject: completed.project, editingStartTime: completed.startTime, loggedInPage: $author$project$Model$Model$EditingCompleted}),
				$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Model$Model$UserIdResult = function (a) {
	return {$: 'UserIdResult', a: a};
};
...
var $author$project$Update$Update$fetchUserId = F2(
	function (model, endpoint) {
		return $elm$http$Http$post(
			{
				body: $elm$http$Http$jsonBody(
					A2($author$project$Update$Update$credsEncoder, model.userName, model.password)),
				expect: A2($elm$http$Http$expectJson, $author$project$Model$Model$UserIdResult, $elm$json$Json$Decode$int),
				url: _Utils_ap($author$project$Update$Update$api, endpoint)
			});
	});
var $author$project$Update$Update$getTimeFrameFromString = function (timeFrame) {
	switch (timeFrame) {
		case 'Year':
			return $author$project$Model$Model$Year;
		case 'Month':
			return $author$project$Model$Model$Month;
		case 'Day':
			return $author$project$Model$Model$Day;
		case 'Hour':
			return $author$project$Model$Model$Hour;
		case 'Minute':
			return $author$project$Model$Model$Minute;
		case 'Second':
			return $author$project$Model$Model$Second;
		default:
			return $author$project$Model$Model$Minute;
	}
};
var $elm$browser$Browser$Dom$getViewport = _Browser_withWindow(_Browser_getViewport);
var $author$project$Update$Update$handleDeletedResult = F2(
	function (model, result) {
		if (result.$ === 'Ok') {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		} else {
			var err = result.a;
			var x = A2($elm$core$Debug$log, 'handleDeletedResult', err);
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
				...
				switch (timeFrame.$) {
					case 'Hour':
						return ((t >= 0) && (t <= 23)) ? _Utils_update(
							...
							{
								completedFromTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedFromTime) + ((t - A2($elm$time$Time$toHour, model.timeZone, model.completedFromTime)) * $author$project$Model$Model$hours))
							}) : model;
					case 'Minute':
						return ((t >= 0) && (t <= 59)) ? _Utils_update(
							...
							{
								completedFromTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedFromTime) + ((t - A2($elm$time$Time$toMinute, model.timeZone, model.completedFromTime)) * $author$project$Model$Model$mins))
							}) : model;
					case 'Second':
						return ((t >= 0) && (t <= 59)) ? _Utils_update(
							model,
							{
								completedFromTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedFromTime) + ((t - A2($elm$time$Time$toSecond, model.timeZone, model.completedFromTime)) * $author$project$Model$Model$secs))
							}) : model;
					default:
						return model;
				}
				...
				switch (timeFrame.$) {
					case 'Hour':
						return ((t >= 0) && (t <= 23)) ? _Utils_update(
							...
							{
								completedToTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedToTime) + ((t - A2($elm$time$Time$toHour, model.timeZone, model.completedToTime)) * $author$project$Model$Model$hours))
							}) : model;
					case 'Minute':
						return ((t >= 0) && (t <= 59)) ? _Utils_update(
							model,
							{
								completedToTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedToTime) + ((t - A2($elm$time$Time$toMinute, model.timeZone, model.completedToTime)) * $author$project$Model$Model$mins))
							}) : model;
					case 'Second':
						return ((t >= 0) && (t <= 59)) ? _Utils_update(
							model,
							{
								completedToTime: $elm$time$Time$millisToPosix(
									$elm$time$Time$posixToMillis(model.completedToTime) + ((t - A2($elm$time$Time$toSecond, model.timeZone, model.completedToTime)) * $author$project$Model$Model$secs))
							}) : model;
					default:
						return model;
				}
...
var $author$project$Update$Update$handleUpdatedItemResult = F2(
	function (model, result) {
		if (result.$ === 'Ok') {
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		} else {
			var err = result.a;
			var x = A2($elm$core$Debug$log, 'handleUpdatedItemResult', err);
			return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$Update$Update$initViewport = F2(
	function (model, vp) {
		...
		var x = A2($elm$core$Debug$log, 'newVp:', newVp);
		var dev = $mdgriffith$elm_ui$Element$classifyDevice(newVp);
		var y = A2($elm$core$Debug$log, 'devic:', dev);
		return _Utils_update(
			model,
			{device: dev, window: newVp});
	});
			...
			return $elm$http$Http$post(
				{
					...
					expect: $elm$http$Http$expectWhatever($author$project$Model$Model$CreatedItemId),
					url: _Utils_ap(
						$author$project$Update$Update$api,
						_Utils_ap(
							endpoint,
...
var $author$project$Update$Update$toggleTimer = function (model) {
	if (model.timing) {
		var completed = {
			...
			id: $billstclair$elm_sha256$Sha256$sha256(
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{
					completedList: A2($elm$core$List$cons, completed, model.completedList),
		...
		return _Utils_Tuple2(
			_Utils_update(
				model,
				{loggedInPage: $author$project$Model$Model$Timing, startTime: model.currentTime, timing: true}),
			$elm$core$Platform$Cmd$none);
	}
};
var $author$project$Update$Update$useCreatedItemId = F2(
	function (model, result) {
		if (result.$ === 'Ok') {
			return model;
		} else {
			var err = result.a;
			var x = A2($elm$core$Debug$log, 'useCreatedItem', err);
			return model;
		}
	});
		...
		if (result.$ === 'Ok') {
			...
			return _Utils_update(
				model,
				{
					...
					currentProject: (model.currentProject === '') ? hd : model.currentProject,
					projectList: projects,
					projectShown: (model.projectShown === '') ? hd : model.projectShown
				});
		} else {
			var err = result.a;
			var y = A2($elm$core$Debug$log, 'error ', err);
			return model;
		}
	});
		...
		switch (msg.$) {
			...
			case 'ChangeEditTime':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'ChangeEditingStartTimeFrame':
				var timeFrame = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							editingStartTimeFrame: $author$project$Update$Update$getTimeFrameFromString(timeFrame)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeEditingEndTimeFrame':
				var timeFrame = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							editingEndTimeFrame: $author$project$Update$Update$getTimeFrameFromString(timeFrame)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeCompletedFromTimeFrame':
				var timeFrame = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							completedFromTimeFrame: $author$project$Update$Update$getTimeFrameFromString(timeFrame)
						}),
					$elm$core$Platform$Cmd$none);
			case 'ChangeCompletedToTimeFrame':
				var timeFrame = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							completedToTimeFrame: $author$project$Update$Update$getTimeFrameFromString(timeFrame)
						}),
					$elm$core$Platform$Cmd$none);
			...
			case 'GetUserHistory':
				return _Utils_Tuple2(
					model,
					$author$project$Update$Update$getUserHistory(model.userId));
			case 'ItemDeleted':
				var result = msg.a;
				return A2($author$project$Update$Update$handleDeletedResult, model, result);
			case 'ItemUpdated':
				var result = msg.a;
				return A2($author$project$Update$Update$handleUpdatedItemResult, model, result);
			case 'CreateAccountPage':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{loginStatus: $author$project$Model$Model$Signup}),
					$elm$core$Platform$Cmd$none);
			case 'LoginPage':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{loginStatus: $author$project$Model$Model$LoggedOut}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleProjectDropDown':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showProjectDropDown: !model.showProjectDropDown}),
					$elm$core$Platform$Cmd$none);
			case 'CloseMenu':
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'HandleFilterTimeChange':
				...
				return _Utils_Tuple2(
					...
					$elm$core$Platform$Cmd$none);
			case 'ToggleShowStarted':
				var show = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showByStartTime: show}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleTimeFrameFromDropDown':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showTimeFrameFromDropDown: !model.showTimeFrameFromDropDown}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleTimeFrameToDropDown':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showTimeFrameToDropDown: !model.showTimeFrameToDropDown}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleShowFilterProject':
				var show = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showFilterByProject: show}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleFilterProjectDropDown':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showFilterByProjectDropDown: !model.showFilterByProjectDropDown}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleShowEditingCompletedProjectDropDown':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showEditingCompletedProjectDropDown: !model.showEditingCompletedProjectDropDown}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleShowEditingStartTimeDropDown':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showEditingStartTimeDropDown: !model.showEditingStartTimeDropDown}),
					$elm$core$Platform$Cmd$none);
			case 'ToggleShowEditingEndTimeDropDown':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{showEditingEndTimeDropDown: !model.showEditingEndTimeDropDown}),
					$elm$core$Platform$Cmd$none);
			case 'ShowHistory':
				return _Utils_Tuple2(
					_Utils_update(
			...
			default:
				return model.timing ? _Utils_Tuple2(
					_Utils_update(
						model,
						{loggedInPage: $author$project$Model$Model$Timing}),
...
var $author$project$Update$Update$useCreatedItemList = F2(
	function (model, result) {
		if (result.$ === 'Ok') {
			...
			var err = result.a;
			var x = A2($elm$core$Debug$log, 'userCreatedItemList', err);
			return A2($author$project$Update$Update$update, $author$project$Model$Model$GetUserHistory, model);
		}
	});
	...
	function (model, result) {
		if (result.$ === 'Ok') {
			...
			var updatedModel = _Utils_update(
				model,
				{
					loginStatus: $author$project$Model$Model$LoggedIn,
					userId: $elm$core$Maybe$Just(userId)
				});
...
var $author$project$Model$Model$Home = {$: 'Home'};
var $author$project$Model$Model$ShowHistory = {$: 'ShowHistory'};
...
var $author$project$Model$Model$CreateAccountPage = {$: 'CreateAccountPage'};
var $author$project$Model$Model$LoginPage = {$: 'LoginPage'};
var $author$project$Model$Model$Logout = {$: 'Logout'};
...
var $author$project$View$LoginView$viewNavBar = function (model) {
	var historyButton = _Utils_eq(model.loginStatus, $author$project$Model$Model$LoggedIn) ? A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$View$Styles$lightColor),
		...
		{
			label: $mdgriffith$elm_ui$Element$text('History'),
			onPress: $elm$core$Maybe$Just($author$project$Model$Model$ShowHistory)
		}) : $mdgriffith$elm_ui$Element$none;
	var createOrLogoutButton = $author$project$View$LoginView$makeCreateOrLogOutButton(model.loginStatus);
	return A2(
		...
		_List_fromArray(
			[
				...
				{
					label: $mdgriffith$elm_ui$Element$text('timeme.org'),
					onPress: $elm$core$Maybe$Just($author$project$Model$Model$Home)
				}),
				(model.window.width > 600) ? A2(
				$mdgriffith$elm_ui$Element$el,
				_List_fromArray(
...
var $author$project$View$LoginView$viewLoggedOutRow = function (model) {
	var promptText = _Utils_eq(model.loginStatus, $author$project$Model$Model$Signup) ? 'Sign Up' : 'Login';
	var buttonAction = _Utils_eq(model.loginStatus, $author$project$Model$Model$Signup) ? $author$project$Model$Model$CreateAccount : $author$project$Model$Model$Login;
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
				...
				[
					...
					A2(
						...
						_List_Nil,
						{
							...
							onChange: $author$project$Model$Model$ChangeUserName,
					...
					A2(
						...
						{
							label: A2($mdgriffith$elm_ui$Element$Input$labelAbove, _List_Nil, $mdgriffith$elm_ui$Element$none),
							onChange: $author$project$Model$Model$ChangePassword,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
					...
					A2(
							...
							]),
						{
							...
							onPress: $elm$core$Maybe$Just(buttonAction)
						}))
				])));
};
...
var $author$project$View$View$showCurrentDateTime = function (model) {
	return A2(
		...
		$mdgriffith$elm_ui$Element$text(
			A3($author$project$View$DisplayTime$stringDateTime, model.currentTime, model.timeZone, $elm$core$Maybe$Nothing)));
};
var $author$project$Model$Model$ChangeEditNote = function (a) {
	return {$: 'ChangeEditNote', a: a};
};
var $author$project$Model$Model$ChangeEditProject = function (a) {
	return {$: 'ChangeEditProject', a: a};
};
var $author$project$Model$Model$ChangeEditTime = F2(
	function (a, b) {
		return {$: 'ChangeEditTime', a: a, b: b};
	});
var $author$project$Model$Model$ChangeEditingEndTimeFrame = function (a) {
	return {$: 'ChangeEditingEndTimeFrame', a: a};
};
var $author$project$Model$Model$ChangeEditingStartTimeFrame = function (a) {
	return {$: 'ChangeEditingStartTimeFrame', a: a};
};
var $author$project$Model$Model$Decrement = {$: 'Decrement'};
var $author$project$Model$Model$DeleteCompleted = function (a) {
	return {$: 'DeleteCompleted', a: a};
};
var $author$project$Model$Model$DiscardChanges = {$: 'DiscardChanges'};
var $author$project$Model$Model$Editing = function (a) {
	return {$: 'Editing', a: a};
};
var $author$project$Model$Model$End = {$: 'End'};
var $author$project$Model$Model$Increment = {$: 'Increment'};
var $author$project$Model$Model$Start = {$: 'Start'};
				...
				[
					...
					_List_fromArray(
						[
							...
							A4($author$project$View$View$createDropDownRow, $author$project$Model$Model$ToggleShowEditingCompletedProjectDropDown, dropDownItems, 100, model.editingProject)
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
...
var $author$project$View$View$showEditing = function (model) {
	var maybeCompleted = $elm$core$List$head(
		A2(
			$elm$core$List$filter,
			function (completedItem) {
				return _Utils_eq(completedItem.id, model.editingId);
			},
			model.completedList));
	if (maybeCompleted.$ === 'Just') {
		...
		return A2(
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text('No item found with id: ' + model.editingId),
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
					_List_fromArray(
						[
						...
						]),
					{
						...
						onPress: $elm$core$Maybe$Just($author$project$Model$Model$Logout)
					})
				]));
	}
};
var $author$project$Model$Model$ChangeCurrentProject = function (a) {
	return {$: 'ChangeCurrentProject', a: a};
};
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				{
					label: A2($mdgriffith$elm_ui$Element$Input$labelAbove, _List_Nil, $mdgriffith$elm_ui$Element$none),
					onChange: $author$project$Model$Model$NewProject,
					placeholder: $elm$core$Maybe$Just(
						A2(
							$mdgriffith$elm_ui$Element$Input$placeholder,
							_List_Nil,
					...
					]),
				{
					...
					onPress: $elm$core$Maybe$Just($author$project$Model$Model$AddProject)
				})
			]));
};
	...
	var projectList = (model.currentProject === '') ? $mdgriffith$elm_ui$Element$none : A2(
		...
		_List_fromArray(
			[
				...
				A4($author$project$View$View$createDropDownRow, $author$project$Model$Model$ToggleProjectDropDown, dropDownItems, 100, model.currentProject)),
				A2(
				$mdgriffith$elm_ui$Element$Input$button,
				_List_fromArray(
					[
					...
					]),
				{
					...
					onPress: $elm$core$Maybe$Just($author$project$Model$Model$ToggleTimer)
				})
			]));
	return A2(
		$mdgriffith$elm_ui$Element$column,
...
var $author$project$Model$Model$ToggleShowFilterProject = function (a) {
	return {$: 'ToggleShowFilterProject', a: a};
};
...
var $author$project$Model$Model$ChangeShowByProject = function (a) {
	return {$: 'ChangeShowByProject', a: a};
};
...
var $author$project$View$View$createFilterByProjectRow = function (model) {
	if (model.showFilterByProject) {
		...
		return A4($author$project$View$View$createDropDownRow, $author$project$Model$Model$ToggleFilterProjectDropDown, dropDownItems, 100, model.projectShown);
	} else {
...
var $author$project$Model$Model$ChangeCompletedFromTimeFrame = function (a) {
	return {$: 'ChangeCompletedFromTimeFrame', a: a};
};
var $author$project$Model$Model$ChangeCompletedTime = F2(
	function (a, b) {
		return {$: 'ChangeCompletedTime', a: a, b: b};
	});
var $author$project$Model$Model$ChangeCompletedToTimeFrame = function (a) {
	return {$: 'ChangeCompletedToTimeFrame', a: a};
};
var $author$project$Model$Model$ToggleTimeFrameFromDropDown = {$: 'ToggleTimeFrameFromDropDown'};
var $author$project$Model$Model$ToggleTimeFrameToDropDown = {$: 'ToggleTimeFrameToDropDown'};
	...
	function (model, startOrEnd) {
		if (model.showByStartTime) {
			...
			var timeFrameString = function () {
				if (startOrEnd.$ === 'Start') {
					return $author$project$Model$Model$timeFrameToString(model.completedFromTimeFrame);
				} else {
					return $author$project$Model$Model$timeFrameToString(model.completedToTimeFrame);
				}
			}();
			var getTimeFrame = function () {
				if (startOrEnd.$ === 'Start') {
					return A2($author$project$View$DisplayTime$stringDateTime, model.completedFromTime, model.timeZone);
				} else {
					return A2($author$project$View$DisplayTime$stringDateTime, model.completedToTime, model.timeZone);
				}
			}();
			var hour = getTimeFrame(
				$elm$core$Maybe$Just($author$project$Model$Model$Hour));
			var minute = getTimeFrame(
				$elm$core$Maybe$Just($author$project$Model$Model$Minute));
			var month = getTimeFrame(
				$elm$core$Maybe$Just($author$project$Model$Model$Month));
			var second = getTimeFrame(
				$elm$core$Maybe$Just($author$project$Model$Model$Second));
			var year = getTimeFrame(
				$elm$core$Maybe$Just($author$project$Model$Model$Year));
			...
			var day = getTimeFrame(
				$elm$core$Maybe$Just($author$project$Model$Model$Day));
			return A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
							...
							[
									...
									]),
								{
									label: A2(
										...
										$mdgriffith$elm_ui$Element$text('-')),
									onPress: $elm$core$Maybe$Just(
										A2($author$project$Model$Model$ChangeCompletedTime, startOrEnd, $author$project$Model$Model$Decrement))
								}),
									...
									]),
								{
									label: A2(
										...
										$mdgriffith$elm_ui$Element$text('+')),
									onPress: $elm$core$Maybe$Just(
										A2($author$project$Model$Model$ChangeCompletedTime, startOrEnd, $author$project$Model$Model$Increment))
								})
							]))
					]));
		} else {
				...
				[
					...
					_List_fromArray(
						[
							...
							$mdgriffith$elm_ui$Element$text(completed.project))
						])),
					A2(
					$mdgriffith$elm_ui$Element$row,
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[$mdgriffith$elm_ui$Element$centerX, $mdgriffith$elm_ui$Element$Font$bold]),
							$mdgriffith$elm_ui$Element$text(completed.note))
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$centerX]),
					$mdgriffith$elm_ui$Element$text(
						'Started: ' + A3($author$project$View$DisplayTime$stringDateTime, completed.startTime, model.timeZone, $elm$core$Maybe$Nothing))),
					A2(
					$mdgriffith$elm_ui$Element$el,
					_List_fromArray(
						[$mdgriffith$elm_ui$Element$centerX]),
					$mdgriffith$elm_ui$Element$text(
						'Ended: ' + A3($author$project$View$DisplayTime$stringDateTime, completed.endTime, model.timeZone, $elm$core$Maybe$Nothing))),
					A2(
					$mdgriffith$elm_ui$Element$Input$button,
					_List_fromArray(
						[
...
var $author$project$View$FilterView$filterHistoryByProject = F2(
	function (model, completedItem) {
		return model.showFilterByProject ? _Utils_eq(completedItem.project, model.projectShown) : true;
	});
var $author$project$View$FilterView$filterHistoryByStartTime = F2(
	function (model, completedItem) {
		return model.showByStartTime ? ((_Utils_cmp(
			$elm$time$Time$posixToMillis(completedItem.startTime),
			$elm$time$Time$posixToMillis(model.completedFromTime)) > 0) && (_Utils_cmp(
			$elm$time$Time$posixToMillis(completedItem.endTime),
			$elm$time$Time$posixToMillis(model.completedToTime)) < 0)) : true;
	});
...
var $author$project$View$FilterView$filterHistory = function (model) {
	return A2(
		...
		function (item) {
			return $elm$time$Time$posixToMillis(item.startTime) * (-1);
		},
		A2(
			$elm$core$List$filter,
			function (completedItem) {
...
var $author$project$View$View$displayTotalTime = function (model) {
	var completedTimes = A2(
		$elm$core$List$map,
		function (item) {
			return $elm$time$Time$posixToMillis(item.endTime) - $elm$time$Time$posixToMillis(item.startTime);
		},
		$author$project$View$FilterView$filterHistory(model));
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[$mdgriffith$elm_ui$Element$centerX]),
						$mdgriffith$elm_ui$Element$text(model.currentProject))
					])),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(
						A2($author$project$View$DisplayTime$timeSpendString, model.startTime, model.currentTime))
					])),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						{
							label: A2($mdgriffith$elm_ui$Element$Input$labelAbove, _List_Nil, $mdgriffith$elm_ui$Element$none),
							onChange: $author$project$Model$Model$ChangeNote,
							placeholder: $elm$core$Maybe$Just(
								A2(
									$mdgriffith$elm_ui$Element$Input$placeholder,
									_List_Nil,
