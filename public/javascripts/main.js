		...
		return $elm$http$Http$get(
			{
				...
				url: $author$project$Update$Update$api + ('userhistory/' + userId)
			});
	} else {
			...
			return $elm$http$Http$request(
				{
					...
					url: $author$project$Update$Update$api + ($author$project$Update$Update$deleteItemEndPoint + (userId + ('/' + item.id)))
				});
		} else {
			return $elm$core$Platform$Cmd$none;
		}
		...
		return $elm$http$Http$post(
			{
				...
				expect: A2($elm$http$Http$expectJson, $author$project$Model$Model$UserHashResult, $elm$json$Json$Decode$string),
